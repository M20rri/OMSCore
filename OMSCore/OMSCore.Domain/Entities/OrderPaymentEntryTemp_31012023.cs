...
[Keyless]
[Table("OrderPaymentEntryTemp_31012023")]
public partial class OrderPaymentEntryTemp_31012023
{
    [Column(TypeName = "int(11)")]
    public int Id { get; set; }

    [Column(TypeName = "enum('Payment','Cancel','Sale','BCredit','Waiveoff','Refund','BCPayment','BC to Payment Gateway','Gift','Gift Card Sale','Gift Card Redeem','Exchange Refund','Exchange Cancel')")]
